...
CREATE TRIGGER update_movie_bookmark_trigger
...
CREATE TRIGGER update_movie_like_trigger
...
CREATE TRIGGER update_movies_with_rating_above_trigger
AFTER INSERT ON user_rating
FOR EACH ROW
...
CREATE TRIGGER update_movie_comment_trigger
...
CREATE TRIGGER update_active_subscriber_trigger
...
CREATE TRIGGER update_inactive_subscriber_trigger
AFTER INSERT OR UPDATE OR DELETE ON subscription
FOR EACH ROW
...
CREATE TRIGGER update_successful_payment_trigger
AFTER INSERT ON payment
FOR EACH ROW
...
CREATE TRIGGER update_failed_payment_trigger
AFTER INSERT ON payment
FOR EACH ROW
...
CREATE TRIGGER update_user_bookmark_trigger
AFTER INSERT ON bookmark
FOR EACH ROW
...
CREATE TRIGGER update_user_like_trigger
AFTER INSERT ON likes
FOR EACH ROW
...
CREATE TRIGGER update_user_comment_trigger
AFTER INSERT ON comment
FOR EACH ROW
...
CREATE TRIGGER update_active_subscription_user_trigger
...
CREATE TRIGGER update_inactive_subscription_user_trigger
AFTER INSERT OR UPDATE ON subscription
FOR EACH ROW
...
CREATE TRIGGER update_genre_trigger
...
CREATE TRIGGER update_rating_umur_trigger
